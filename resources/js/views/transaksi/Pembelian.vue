                ...
                <div class="col-4">
                  <div class="row">
                    ...
                    <div class="col-8 text-right">
                      <h1
                        style="color: red; font-size: 2rem; font-weight: bold;"
...
export default {
  ...
  methods: {
    ...
    CheckBarang(e) {
      if (e.keyCode === 13) {
        axios
          .post("api/transaksi/pembelian/findproduct", {
    ...
    sellProduct() {
      if (this.listBarang.length > 0) {
        axios
          .post("api/transaksi/pembelian/sellproduct", {
          ...
          .then(res => {
            Swal.fire("Success...", "Produk berhasil di jual", "success");
            this.id_supplier = 0;
            this.subTotal = 0;
            this.jmlBayar = 0;
            this.kembalian = 0;
